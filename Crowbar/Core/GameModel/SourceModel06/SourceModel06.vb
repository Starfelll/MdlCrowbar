...
#Region "Private Methods"
	...
	Protected Overloads Function WriteMeshSmdFile(ByVal smdPathFileName As String, ByVal aModel As SourceMdlModel06) As Enums.StatusMessage
		Dim status As Enums.StatusMessage = StatusMessage.Success
	...
	Public Overloads Function WriteBoneAnimationSmdFile(ByVal smdPathFileName As String, ByVal aSequence As SourceMdlSequenceDesc06, ByVal blendIndex As Integer) As Enums.StatusMessage
		Dim status As Enums.StatusMessage = StatusMessage.Success
