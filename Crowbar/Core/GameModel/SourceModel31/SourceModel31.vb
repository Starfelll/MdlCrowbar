...
#Region "Methods"
	...
	Public Overloads Function WriteMeshSmdFile(ByVal smdPathFileName As String, ByVal lodIndex As Integer, ByVal aVtxModel As SourceVtxModel06, ByVal aModel As SourceMdlModel31, ByVal bodyPartVertexIndexStart As Integer) As Enums.StatusMessage
		Dim status As Enums.StatusMessage = StatusMessage.Success
